...
class MacOSInitializationSettings {
  ...
  /// Default setting that indiciates an alert should be displayed when a notification is triggered while app is in the foreground. Default value is true.
  final bool defaultPresentAlert;

  /// Default setting that indiciates if a sound should be played when a notification is triggered while app is in the foreground. Default value is true.
  final bool defaultPresentSound;

  /// Default setting that indicates if a badge value should be applied when a notification is triggered while app is in the foreground. Default value is true.
